...
class Controls:
  def __init__(self, CI=None):
    ...
    self._dp_toyota_cruise_override = self.params.get_bool("dp_toyota_cruise_override")
    self._dp_toyota_cruise_override_speed = int(self.params.get("dp_toyota_cruise_override_speed", encoding="utf-8"))
    self._dp_auto_lane_change = self.params.get_bool("dp_auto_lane_change")
  ...
  def state_transition(self, CS):
    ...
    dp_override_speed = self._dp_toyota_cruise_override_speed if self._dp_toyota_cruise_override else False
    #print("dp_override_speed:", dp_override_speed)
  ...
  def state_control(self, CS):
    ...
    if not self.CP.passive and self.initialized and self._dp_alka and self._dp_alka_active and not standstill and CS.cruiseState.available:
      if self.sm['liveCalibration'].calStatus != log.LiveCalibrationData.Status.calibrated:
        pass
      elif abs(CS.steeringAngleDeg) >= 540:
        pass
