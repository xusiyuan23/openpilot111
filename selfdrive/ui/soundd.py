...
class Soundd:
  def __init__(self):
    ...
    self.dp_device_audible_alert_mode = int(Params().get("dp_device_audible_alert_mode"))
  ...
  def get_sound_data(self, frames): # get "frames" worth of data from the current alert sound, looping when required
    ...
    if self.current_alert != AudibleAlert.none:
      ...
      if self.dp_device_audible_alert_mode == 1 and self.current_alert not in [AudibleAlert.warningSoft, AudibleAlert.warningImmediate]:
        return ret * self.current_volume
      elif self.dp_device_audible_alert_mode == 2:
        return False
